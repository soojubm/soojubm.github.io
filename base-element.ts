...
/* del {color:var(--color-foreground-light);} */
...
code {display:block;background:var(--color-background-subtle);border-radius:var(--radius);font-family:var(--font-family-code);font-size:var(--font-size-12);letter-spacing:.0125rem;}
svg {color:var(--gray800);}

/* // for appearance on safari */
select {-webkit-appearance:none;background:none;border:none;font:inherit;color:var(--color-foreground);}
...
html {min-width:320px;height:100%;overflow-x:hidden;
  font-family: var(--font-family);
  font-size:16px;
  line-height: var(--font-line-height-24);
  -webkit-text-size-adjust:100%;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;overscroll-behavior:contain;}
body {
  /* min-height: 100%; */
  /* height 100%는 sticky 오류 생길 수 있다. */
  /* max-width: 1440px;
  margin: 0 auto; */
  background:var(--color-background);color:var(--color-foreground);font-weight:var(--font-weight-normal);font-size:.875rem;}
...
table {
  ...
  --table-cell-background: var(--color-background);
  --table-cell-background-hover: var(--color-background-subtle);
...
table caption {padding:.5rem 0;font-size:var(--font-size-12);text-align:left;}
table thead {}
table thead tr th {
...
table tbody tr:hover {background-color:var(--table-cell-background-hover);}
...
// h1,h2,h3,h4,h5,h6 {font-weight:var(--font-weight-bold);color:var(--color-foreground);word-break:keep-all;}
...
.modal-body-subhead {margin:var(--space-4) 0;font-size:var(--font-size-14);}
...
/* // hover-item */
.is-hovered {
  box-shadow: 0 0 0 2px var(--color-background-subtle);
...
/* .books .books-head .books-head-logo{width:60%;max-width:220px}.books .books-head h1{padding:0 var(--grid-margin);font-size:var(--font-size-32)}.books .books-head h1>span{margin-top:-.5rem}.books .books-head .book-head-how ul{flex-wrap:wrap}.books .books-head .book-head-how ul li{width:100%;margin:1.5rem 0}.bookcard{max-width:100%}.bookcard-body{padding-left:1.5rem;padding-right:1.5rem}.bookcard-foot .bookcard-foot-apply{min-width:calc(100% - 3rem);left:1.5rem}}.books-form{padding:0 5%}.books-form dl{display:flex;margin:.5rem 0}.books-form dl dt{width:20%}.books-form dl dd{width:80%}.books-complete{text-align:center;padding:4rem 5% 6rem}.books-complete h1{margin:1rem 0 2rem;font-size:var(--font-size-32)} */
