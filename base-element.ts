...
code {display:block;background:var(--color-background-weak);border-radius:var(--radius);font-family:var(--font-family-code);font-size:var(--font-size-12);letter-spacing:.0125rem;}
...
table {
  ...
  --table-cell-background-hover: var(--color-background-weak);
