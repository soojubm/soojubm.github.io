...
export const tagStyles = css`
  ...
  :host([data-variant='feature1']) {
    border-color: transparent;
    background: var(--color-temp1);
    color: var(--gray800);
  }

  :host([data-variant='feature2']) {
    border-color: transparent;
    background: var(--color-temp2);
    color: var(--gray800);
  }

  :host([data-variant='feature3']) {
    border-color: transparent;
    background: var(--color-temp3);
    color: var(--gray800);
  }

  :host([data-variant='feature4']) {
    border-color: transparent;
    background: var(--color-temp4);
    color: var(--gray800);
  }

  :host([data-variant='hashtag']) {
    padding: 0;
    border: 0;
    color: var(--color-foreground-light);
  }

  :host([data-variant='hashtag'])::before {
    content: '#';
  }
`
