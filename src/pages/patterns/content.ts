...
const main = html`
  <main class="page">
    ...
    <mm-content-section-list>
      <mm-content-section heading-level="3" heading="Easy scanning">
        <mm-paragraph>
      ...
      <mm-content-section heading-level="3" heading="Message / Description">
        <mm-paragraph>
      ...
      <mm-content-section heading-level="3" heading="Interaction Label">
        <mm-paragraph>
