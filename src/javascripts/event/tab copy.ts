...
const tabMenu = () => {
  const indicatorElement = document.querySelector<HTMLElement>('.tablist-indicator')
...
//     const tabIndicator = tab?.parentNode?.querySelector<HTMLElement>('.tablist-indicator')
//     if (tabIndicator) {
